...
/// Controls how recent errors must be to appear in the email body. Defauls to 1 hour.
@property (nonatomic) NSTimeInterval maximumAgeForErrorLogsToIncludeInEmailBody;
