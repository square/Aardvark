...
//! Project version number for AardvarkLoggingUI.
FOUNDATION_EXPORT double AardvarkLoggingUIVersionNumber;

//! Project version string for AardvarkLoggingUI.
FOUNDATION_EXPORT const unsigned char AardvarkLoggingUIVersionString[];
